 ...
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
/* CLIB (newlib) so lv_label_set_text_fmt() supports "%f" -- the built-in
 * sprintf has float disabled (LV_USE_FLOAT 0), which corrupts any args after
 * a "%f" in the format string. */
